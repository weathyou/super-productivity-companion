...
- **Enable desktop companion bridge (desktop only)**: Publishes the current task and productivity mode to a local Clawd on Desk instance. This is opt-in, local-only, and display-only; it does not allow Clawd to modify tasks.
