...
const CLIENT_ID = 'REPLACE_WITH_GOOGLE_DESKTOP_CLIENT_ID';
...
const CLIENT_SECRET = 'REPLACE_WITH_GOOGLE_DESKTOP_CLIENT_SECRET';
...
const MOBILE_CLIENT_ID = 'REPLACE_WITH_GOOGLE_ANDROID_CLIENT_ID';
// iOS OAuth client ID — authenticates via bundle ID.
// Requires "Custom URI scheme" to be enabled in Google Cloud Console.
const IOS_CLIENT_ID = 'REPLACE_WITH_GOOGLE_IOS_CLIENT_ID';
