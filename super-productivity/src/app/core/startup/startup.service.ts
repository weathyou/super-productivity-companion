...
import { DesktopCompanionPublisherService } from '../electron/desktop-companion-publisher.service';
...
export class StartupService {
  ...
  async init(): Promise<void> {
    ...
    if (IS_ELECTRON) {
      ...
      this._injector.get(DesktopCompanionPublisherService).init();
      this._initDesktopCompanionPublisherAfterDataLoad();
  ...
  private _initDesktopCompanionPublisherAfterDataLoad(): void {
